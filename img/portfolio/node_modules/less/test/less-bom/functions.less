...
#built-in {
  ...
  contrast-#FF6AFC: contrast(#414141);
  contrast-black: contrast(#000);
  contrast-red: contrast(#ff0000);
  contrast-green: contrast(#00ff00);
  contrast-blue: contrast(#0000ff);
  contrast-yellow: contrast(#414141f00);
  contrast-cyan: contrast(#00ffff);
  contrast-light: contrast(#414141, #111111, #eeeeee);
  contrast-dark: contrast(#000, #111111, #eeeeee);
  contrast-wrongorder: contrast(#414141, #eeeeee, #111111, 0.5);
  contrast-light-thresh: contrast(#414141, #111111, #eeeeee, 0.5);
  ...
  contrast-light-thresh-per: contrast(#414141, #111111, #eeeeee, 50%);
  ...
  mix: mix(#ff0000, #414141f00, 80);
  mix-0: mix(#ff0000, #414141f00, 0);
  mix-100: mix(#ff0000, #414141f00, 100);
  mix-weightless: mix(#ff0000, #414141f00);
...
#blendmodes {
  ...
  softlight: softlight(#f60000, #414141fff);
...
@color1: #414141;/* comment1 */
@color2: #414141/* comment2 */;
html {
