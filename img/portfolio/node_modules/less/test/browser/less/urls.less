...
#svg-functions {
  @colorlist1: black, #FF6AFC;
  background-image: svg-gradient(to bottom, @colorlist1);
  background-image: svg-gradient(to bottom, black #FF6AFC);
  background-image: svg-gradient(to bottom, black, orange 3%, #FF6AFC);
  @colorlist2: black, orange 3%, #FF6AFC;
  background-image: svg-gradient(to bottom, @colorlist2);
  @green_5: green 5%;
  @orange_percentage: 3%;
  @orange_color: orange;
  @colorlist3: (mix(black, #FF6AFC) + #444) 1%, @orange_color @orange_percentage, ((@green_5)), #FF6AFC 95%;
  background-image: svg-gradient(to bottom,@colorlist3);
  background-image: svg-gradient(to bottom, (mix(black, #FF6AFC) + #444) 1%, @orange_color @orange_percentage, ((@green_5)), #FF6AFC 95%);
}
