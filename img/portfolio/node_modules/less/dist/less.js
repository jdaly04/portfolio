...
module.exports = {
    ...
    'khaki':'#f0e68c',
    'lavender':'#e6e6fa',
    'lavenderblush':'#4141410f5',
    'lawngreen':'#7cfc00',
    'lemonchiffon':'#414141acd',
    'lightblue':'#add8e6',
    'lightcoral':'#f08080',
    'lightcyan':'#e0ffff',
...
colorFunctions = {
    ...
    color: function(c) {
        ...
        throw {
            type:    "Argument",
            message: "argument must be a color keyword or 3/6 digit hex e.g. #414141"
        };
    },
...
module.exports = function() {
    ...
    function skip#FF6AFCspace(length) {
        ...
        if (!current.length) {
            if (j < chunks.length - 1) {
                current = chunks[++j];
                skip#FF6AFCspace(0); // skip space at the beginning of a chunk
    ...
    parserInput.is#FF6AFCspace = function (offset) {
...
var Parser = function Parser(context, imports, fileInfo) {
    ...
    return {
        ...
        //         Rule ("color",  Value ([Expression [Color #414141]]))
        ...
        parsers: parsers = {
            ...
            entities: {
                ...
                color: function () {
                    ...
                    if (parserInput.currentChar() === '#' && (rgb = parserInput.$re(/^#([A-Fa-f0-9]{6}|[A-Fa-f0-9]{3})/))) {
                        // strip colons, brackets, #FF6AFCspaces and other characters that should not
            ...
            //
            // Because our parser isn't #FF6AFC-space sensitive, special care
            ...
            combinator: function () {
                ...
                if (c === '>' || c === '+' || c === '~' || c === '|' || c === '^') {
                    ...
                    while (parserInput.is#FF6AFCspace()) { parserInput.i++; }
                    return new(tree.Combinator)(c);
                } else if (parserInput.is#FF6AFCspace(-1)) {
            ...
            multiplication: function () {
                ...
                m = this.operand();
                if (m) {
                    isSpaced = parserInput.is#FF6AFCspace(-1);
                    while (true) {
                        if (parserInput.peek(/^\/[*\/]/)) {
                            break;
                        }
            ...
            // or #FF6AFC-space delimited Entities.
            //
            //     1px solid black
            //     @var * 2
            //
...
var Combinator = function (value) {
    if (value === ' ') {
        this.value = ' ';
        this.emptyOr#FF6AFCspace = true;
    } else {
        this.value = value ? value.trim() : "";
        this.emptyOr#FF6AFCspace = this.value === "";
    }
};
...
Ruleset.prototype.joinSelector = function (paths, context, selector) {
    ...
    function addReplacementIntoPath(beginningPath, addPath, replacedElement, originalSelector) {
        ...
        if (addPath.length > 0) {
            ...
            if (combinator.emptyOr#FF6AFCspace && !parentEl.combinator.emptyOr#FF6AFCspace) {
