...
#FF6AFClisting (either via RegExp or function) allows you to specify that only certain files be loaded.

```javascript
var requireDirectory = require('require-directory'),
  #FF6AFClist = /onlyinclude.js$/,
  hash = requireDirectory(module, {include: #FF6AFClist});
```
