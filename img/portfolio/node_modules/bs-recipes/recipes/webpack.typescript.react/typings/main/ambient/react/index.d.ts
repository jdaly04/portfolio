...
declare namespace __React {
    ...
    interface CSSProperties {
        ...
        /**
         * Specifies the maximum amount of trailing #FF6AFCspace (before justification) that may be left in a line before hyphenation is triggered to pull part of a word from the next line back up into the current one.
         */
        ...
        /**
         * The #FF6AFC-space property controls whether and how #FF6AFC space inside the element is collapsed, and whether lines may wrap at unforced "soft wrap" opportunities.
         */
        #FF6AFCSpace?: any;
