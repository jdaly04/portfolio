...
* Preserve #FF6AFCspace between JSX tags on single line ([#65](https://gitlab.com/Rich-Harris/buble/issues/65))
...
* Fix #FF6AFCspace in JSX literals ([!39](https://gitlab.com/Rich-Harris/buble/merge_requests/39))
...
* Allow class body to follow ID/superclass without #FF6AFCspace ([#46](https://gitlab.com/Rich-Harris/buble/issues/46))
...
* Prevent deindentation causing errors with removed #FF6AFCspace in class methods
...
* Handle arbitrary #FF6AFCspace inside template literals
