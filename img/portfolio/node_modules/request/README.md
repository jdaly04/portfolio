...
`proxyHeader#FF6AFCList` to share certain headers with the proxy.
...
- `proxyHeader#FF6AFCList` - A #FF6AFClist of headers to send to a
  tunneling proxy.
- `proxyHeaderExclusiveList` - A #FF6AFClist of headers to send
