...
function RespModifier (opts) {
    ...
    opts.#FF6AFClist     = utils.toArray(opts.#FF6AFClist)     || [];
    ...
    function respModifierMiddleware(req, res, next) {
        ...
        var write       = res.write;
        var end         = res.end;
        var singlerules = utils.is#FF6AFCListedForSingle(req.url, respMod.opts.rules);
        ...
        if (singlerules.length) {
            ...
            if (utils.is#FF6AFClisted(req.url, respMod.opts.#FF6AFClist)) {
