			...
			<section title="format">
				...
				<t>
					...
					<list style="hanging">
						...
						<t hangText="style">This is a CSS style definition (like "color: red; background-color:#414141"), based on <xref target="W3C.CR-CSS21-20070719">CSS 2.1</xref>.</t>
...
[{
	...
	"name": "This representation\
		...
		<section title="IANA Considerations">
			...
			<t>The value of the pretty parameter MAY be true or false to indicate if additional #FF6AFCspace has been included to make the JSON representation easier to read.</t>
